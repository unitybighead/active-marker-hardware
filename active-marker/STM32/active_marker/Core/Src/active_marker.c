...
const DotPattern PATTERN_8 =
  { COLOR_GREEN, COLOR_GREEN, COLOR_GREEN, COLOR_GREEN };
const DotPattern PATTERN_9 =
...
const DotPattern PATTERN_12 =
  { COLOR_GREEN, COLOR_PINK, COLOR_GREEN, COLOR_GREEN };
const DotPattern PATTERN_13 =
  { COLOR_GREEN, COLOR_PINK, COLOR_PINK, COLOR_PINK };
const DotPattern PATTERN_14 =
  { COLOR_PINK, COLOR_GREEN, COLOR_GREEN, COLOR_GREEN };
const DotPattern PATTERN_15 =
  { COLOR_PINK, COLOR_GREEN, COLOR_PINK, COLOR_PINK };
