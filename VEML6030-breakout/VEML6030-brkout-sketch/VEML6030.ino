...
uint8_t VEML6030::begin(uint8_t _ADR, uint8_t sda, uint8_t scl) // Initialize library for subsequent pressure measurements
{
	ADR = _ADR;
    Wire.begin(sda,scl);  // Arduino Wire library initializer
